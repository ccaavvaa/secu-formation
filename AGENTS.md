...
- `npm test` → `node --import tsx --test src/test/app.test.ts`; extend this list as additional suites land.
...
- Run linting and tests (`npm run lint && npm test`) before opening a pull request.
